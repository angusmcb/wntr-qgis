...
def wntr_result_at_current_time(column, feature, parent, context):
    """
    Gets an individual result for the specified parameter.

    If 'temporal navigation' is activated, this will be the result for the currently viewed 'start time'. This will be interpolated if necessary.
