...
<qgis maxScale="0" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" labelsEnabled="1" simplifyDrawingHints="0" symbologyReferenceScale="-1" simplifyDrawingTol="1" styleCategories="AllStyleCategories" minScale="100000000" simplifyMaxScale="1" version="3.38.3-Grenoble">
  <flags>
  ...
  <temporal enabled="1" accumulate="0" limitMode="0" durationUnit="min" fixedDuration="0" endExpression="" startExpression="" startField="" mode="5" endField="" durationField="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation extrusionEnabled="0" extrusion="0" zscale="1" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0" binding="Centroid" type="IndividualFeatures" clamping="Terrain" zoffset="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{dcd79c98-7f0b-4f25-b1c9-93ad419295b4}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="fill" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleFill" id="{642e6e58-9370-440e-90c3-fab43571f1a3}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{764f86a1-1fa3-4102-b2bf-078006cb734c}">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" graduatedMethod="GraduatedColor" type="graduatedSymbol" enableorderby="0" attr=" wntr_result_at_current_time( &quot;pressure&quot;)" referencescale="-1" symbollevels="0">
    <ranges>
      <range render="true" uuid="{33a3ae59-fe63-4338-b835-3b27863217c7}" label="&lt;0" symbol="0" upper="0.000000000000000" lower="-9000000000.000000000000000"/>
      <range render="true" uuid="{d4445c1a-5d54-4b22-ac6d-1122ef5b0ded}" label="0 - 5" symbol="1" upper="5.000000000000000" lower="0.000000000000000"/>
      <range render="true" uuid="{f21109cc-c01a-43cb-80b5-829961c96b18}" label="5 - 10" symbol="2" upper="10.000000000000000" lower="5.000000000000000"/>
      <range render="true" uuid="{eec52b09-c19e-4be0-a624-ea2838e70ac5}" label="10 - 30" symbol="3" upper="30.000000000000000" lower="10.000000000000000"/>
      <range render="true" uuid="{f04f1684-e4f6-415b-ac19-22a11a44399d}" label="30 - 50" symbol="4" upper="50.000000000000000" lower="30.000000000000000"/>
      <range render="true" uuid="{086237f1-5a87-44f4-a75b-d6a66abcd3fd}" label="50 - 100" symbol="5" upper="100.000000000000000" lower="50.000000000000000"/>
      <range render="true" uuid="{1642a1bc-321e-4ea6-88ba-d4620aaec04b}" label="100 - 160" symbol="6" upper="160.000000000000000" lower="100.000000000000000"/>
      <range render="true" uuid="{bf1a9d57-ad1a-4483-b00d-8fcfb0bd47ce}" label=">160" symbol="7" upper="1000000000000.000000000000000" lower="160.000000000000000"/>
    </ranges>
    <symbols>
      <symbol alpha="1" name="0" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{c2afada2-3345-45eb-a340-bb2c41c0ed18}">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="48,18,59,255,rgb:0.18823529411764706,0.07058823529411765,0.23137254901960785,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
      ...
      <symbol alpha="1" name="1" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{c2afada2-3345-45eb-a340-bb2c41c0ed18}">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="62,156,254,255,rgb:0.24235904478522927,0.61019302662699326,0.99607843137254903,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
      ...
      <symbol alpha="1" name="2" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{c2afada2-3345-45eb-a340-bb2c41c0ed18}">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="72,248,130,255,rgb:0.28078126192111086,0.97254901960784312,0.51137560082398714,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
      ...
      <symbol alpha="1" name="3" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{c2afada2-3345-45eb-a340-bb2c41c0ed18}">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="226,220,56,255,rgb:0.88705271992065304,0.86196688792248422,0.21803616388189517,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
      ...
      <symbol alpha="1" name="4" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{c2afada2-3345-45eb-a340-bb2c41c0ed18}">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="239,210,18,255,hsv:0.14444444444444443,0.92549019607843142,0.93725490196078431,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
      ...
      <symbol alpha="1" name="5" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{c2afada2-3345-45eb-a340-bb2c41c0ed18}">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="230,74,2,255,hsv:0.05277777777777778,0.99215686274509807,0.90196078431372551,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
      ...
      <symbol alpha="1" name="6" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <symbol alpha="1" name="7" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{c2afada2-3345-45eb-a340-bb2c41c0ed18}">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
            <Option value="255,0,4,255,hsv:0.99722222222222223,1,1,1" name="color" type="QString"/>
            <Option value="1" name="horizontal_anchor_point" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="circle" name="name" type="QString"/>
            <Option value="0,0" name="offset" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{d5c55d7c-32b4-4151-80ea-2f68dba25179}">
          <Option type="Map">
            <Option value="0" name="angle" type="QString"/>
            <Option value="square" name="cap_style" type="QString"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontWordSpacing="0" tabStopDistance="80" fontLetterSpacing="0" multilineHeightUnit="Percentage" forcedBold="0" fontItalic="0" fontWeight="50" fontUnderline="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" forcedItalic="0" textOrientation="horizontal" fontSize="10" tabStopDistanceUnit="Point" fontKerning="1" allowHtml="0" capitalization="0" blendMode="0" multilineHeight="1" fontSizeUnit="Point" textColor="50,50,50,255,rgb:0.19607843137254902,0.19607843137254902,0.19607843137254902,1" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" useSubstitutions="0" namedStyle="Regular" isExpression="1" legendString="Aa" fontStrikeout="0" fieldName="concat('Q:',format_number( wntr_result_at_current_time( demand ),1),'\n','H:',format_number(wntr_result_at_current_time( head ), 1),'\nP:',format_number(wntr_result_at_current_time( pressure ),1))" fontFamily="Open Sans" textOpacity="1" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0">
        <families/>
        <text-buffer bufferSizeUnits="MM" bufferBlendMode="0" bufferSizeMapUnitScale="3x:0,0,0,0,0,0" bufferOpacity="1" bufferSize="1" bufferDraw="0" bufferNoFill="1" bufferJoinStyle="128" bufferColor="250,250,250,255,rgb:0.98039215686274506,0.98039215686274506,0.98039215686274506,1"/>
        <text-mask maskOpacity="1" maskSize="1.5" maskJoinStyle="128" maskSizeUnits="MM" maskType="0" maskEnabled="0" maskSize2="1.5" maskSizeMapUnitScale="3x:0,0,0,0,0,0" maskedSymbolLayers=""/>
        <background shapeSVGFile="" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeBorderWidthUnit="Point" shapeSizeType="0" shapeBorderWidth="0" shapeRadiiY="0" shapeDraw="0" shapeRotation="0" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeRadiiX="0" shapeOpacity="1" shapeBorderColor="128,128,128,255,rgb:0.50196078431372548,0.50196078431372548,0.50196078431372548,1" shapeRotationType="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeBlendMode="0" shapeOffsetUnit="Point" shapeJoinStyle="64" shapeOffsetX="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255,rgb:1,1,1,1" shapeOffsetY="0" shapeSizeY="0" shapeSizeX="0" shapeRadiiUnit="Point" shapeSizeUnit="Point" shapeType="0">
          <symbol alpha="1" name="markerSymbol" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
          ...
          <symbol alpha="1" name="fillSymbol" is_animated="0" frame_rate="10" type="fill" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
        ...
        <shadow shadowOffsetDist="1" shadowUnder="0" shadowOffsetAngle="135" shadowScale="100" shadowRadiusUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.69999999999999996" shadowBlendMode="6" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowDraw="0" shadowOffsetUnit="MM" shadowColor="0,0,0,255,rgb:0,0,0,1" shadowRadius="1.5" shadowRadiusAlphaOnly="0" shadowOffsetGlobal="1"/>
        <dd_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
      ...
      <text-format wrapChar="" autoWrapLength="0" formatNumbers="0" decimals="3" rightDirectionSymbol=">" leftDirectionSymbol="&lt;" reverseDirectionSymbol="0" multilineAlign="3" addDirectionSymbol="0" placeDirectionSymbol="0" plussign="0" useMaxLineLengthForAutoWrap="1"/>
      <placement polygonPlacementFlags="2" overrunDistance="0" geometryGeneratorType="PointGeometry" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" overlapHandling="PreventOverlap" maximumDistance="0" maxCurvedCharAngleOut="-25" distMapUnitScale="3x:0,0,0,0,0,0" repeatDistanceUnits="MM" dist="0" maxCurvedCharAngleIn="25" distUnits="MM" offsetUnits="MM" centroidInside="0" maximumDistanceUnit="MM" geometryGeneratorEnabled="0" placement="6" allowDegraded="0" placementFlags="10" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" offsetType="1" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" layerType="PointGeometry" xOffset="0" yOffset="0" rotationAngle="0" lineAnchorPercent="0.5" rotationUnit="AngleDegrees" fitInPolygonOnly="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" repeatDistance="0" lineAnchorType="0" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" overrunDistanceUnit="MM" centroidWhole="0" lineAnchorTextPoint="FollowPlacement" lineAnchorClipping="0" prioritization="PreferCloser" geometryGenerator="" quadOffset="4" priority="5"/>
      <rendering mergeLines="0" obstacleType="1" obstacleFactor="1" upsidedownLabels="0" maxNumLabels="2000" zIndex="0" limitNumLabels="0" drawLabels="1" labelPerPart="0" unplacedVisibility="0" fontMinPixelSize="3" obstacle="1" fontMaxPixelSize="10000" scaleMax="0" minFeatureSize="0" scaleMin="0" fontLimitPixelSize="0" scaleVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option value="" name="name" type="QString"/>
          <Option name="properties"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory scaleBasedVisibility="0" penWidth="0" showAxis="1" width="15" diagramOrientation="Up" direction="0" spacingUnit="MM" spacing="5" penColor="#000000" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" spacingUnitScale="3x:0,0,0,0,0,0" enabled="0" height="15" rotationOffset="270" penAlpha="255" scaleDependency="Area" sizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" backgroundColor="#ffffff" lineSizeType="MM" sizeType="MM" barWidth="5" backgroundAlpha="255" opacity="1" minimumSize="0">
      <fontProperties italic="0" style="" bold="0" underline="0" strikethrough="0" description="Ubuntu,11,-1,5,50,0,0,0,0,0"/>
      ...
      <axisSymbol>
        <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
          ...
          <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{fd9eaf79-af93-4638-9fcf-3b8b4cb44c1c}">
            <Option type="Map">
              <Option value="0" name="align_dash_pattern" type="QString"/>
              <Option value="square" name="capstyle" type="QString"/>
              <Option value="5;2" name="customdash" type="QString"/>
  ...
  <DiagramLayerSettings showAll="1" linePlacementFlags="18" placement="0" zIndex="0" priority="0" dist="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="demand" configurationFlags="NoFlag">
    ...
    <field name="head" configurationFlags="NoFlag">
      <editWidget type="List">
        <config>
          <Option type="Map">
            <Option value="false" name="EmptyIsEmptyArray" type="bool"/>
    ...
    <field name="pressure" configurationFlags="NoFlag">
      <editWidget type="List">
        <config>
          <Option type="Map">
            <Option value="false" name="EmptyIsEmptyArray" type="bool"/>
  ...
  <aliases>
    ...
    <alias name="" index="1" field="demand"/>
    <alias name="" index="2" field="head"/>
    <alias name="" index="3" field="pressure"/>
    <alias name="" index="4" field="quality"/>
  </aliases>
  <splitPolicies>
    <policy policy="Duplicate" field="name"/>
    <policy policy="DefaultValue" field="demand"/>
    <policy policy="DefaultValue" field="head"/>
    <policy policy="DefaultValue" field="pressure"/>
    <policy policy="DefaultValue" field="quality"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy policy="Duplicate" field="name"/>
    <policy policy="Duplicate" field="demand"/>
    <policy policy="Duplicate" field="head"/>
    <policy policy="Duplicate" field="pressure"/>
    <policy policy="Duplicate" field="quality"/>
  </duplicatePolicies>
  <defaults>
    <default applyOnUpdate="0" field="name" expression=""/>
    <default applyOnUpdate="0" field="demand" expression=""/>
    <default applyOnUpdate="0" field="head" expression=""/>
    <default applyOnUpdate="0" field="pressure" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="demand" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="head" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="pressure" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="quality" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="name" exp="" desc=""/>
    <constraint field="demand" exp="" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="demand" type="field" width="-1"/>
      <column hidden="0" name="head" type="field" width="-1"/>
      <column hidden="0" name="pressure" type="field" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <labelOnTop>
    <field name="base_demand" labelOnTop="0"/>
    <field name="base_head" labelOnTop="0"/>
    ...
    <field name="initial_quality" labelOnTop="0"/>
  ...
  <reuseLastValue>
    <field name="base_demand" reuseLastValue="0"/>
    <field name="base_head" reuseLastValue="0"/>
    <field name="datetime" reuseLastValue="0"/>
    <field name="demand" reuseLastValue="0"/>
    <field name="elevation" reuseLastValue="0"/>
    <field name="fid" reuseLastValue="0"/>
    <field name="head" reuseLastValue="0"/>
    <field name="initial_quality" reuseLastValue="0"/>
    <field name="name" reuseLastValue="0"/>
    <field name="node_type" reuseLastValue="0"/>
    <field name="pressure" reuseLastValue="0"/>
