...
<qgis minScale="100000000" styleCategories="AllStyleCategories" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyAlgorithm="0" readOnly="0" labelsEnabled="0" simplifyLocal="1" version="3.38.3-Grenoble" symbologyReferenceScale="-1" simplifyMaxScale="1" maxScale="0" hasScaleBasedVisibilityFlag="0">
  ...
  <temporal startExpression="" startField="" enabled="0" accumulate="0" limitMode="0" endField="" durationUnit="min" mode="0" durationField="power" fixedDuration="0" endExpression="">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  ...
  <elevation type="IndividualFeatures" zoffset="0" extrusion="0" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0" binding="Centroid" extrusionEnabled="0" clamping="Terrain" zscale="1" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol type="line" is_animated="0" force_rhr="0" alpha="1" frame_rate="10" name="" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" id="{8fee5993-656e-456b-8704-90fc0867c071}" pass="0" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" is_animated="0" force_rhr="0" alpha="1" frame_rate="10" name="" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" id="{929f617a-bbac-4b37-a18c-a09ba5132628}" pass="0" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol type="marker" is_animated="0" force_rhr="0" alpha="1" frame_rate="10" name="" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" id="{73a1fec2-263b-4289-98e3-9038f6378116}" pass="0" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 type="singleSymbol" forceraster="0" symbollevels="0" referencescale="-1" enableorderby="0">
    <symbols>
      <symbol type="line" is_animated="0" force_rhr="0" alpha="1" frame_rate="10" name="0" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" id="{2544c63a-b11c-42c5-8320-db0ee179cc28}" pass="0" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
            ...
            <Option type="QString" value="0.13" name="line_width"/>
            <Option type="QString" value="MM" name="line_width_unit"/>
            <Option type="QString" value="0" name="offset"/>
            <Option type="QString" value="3x:0,0,0,0,0,0" name="offset_map_unit_scale"/>
            <Option type="QString" value="MM" name="offset_unit"/>
        ...
        <layer locked="0" enabled="1" id="{300c7703-f12e-44e2-979e-2d3385c87376}" pass="0" class="MarkerLine">
          <Option type="Map">
          ...
          <symbol type="marker" is_animated="0" force_rhr="0" alpha="1" frame_rate="10" name="@0@1" clip_to_extent="1">
            <data_defined_properties>
              <Option type="Map">
                <Option type="QString" value="" name="name"/>
                <Option name="properties"/>
            ...
            <layer locked="0" enabled="1" id="{22f25270-21b0-41c8-a411-97a6a2661ffe}" pass="0" class="SimpleMarker">
              <Option type="Map">
                <Option type="QString" value="0" name="angle"/>
                <Option type="QString" value="square" name="cap_style"/>
            ...
            <layer locked="0" enabled="1" id="{78392fca-8605-4c44-a01a-2ca00491e674}" pass="0" class="SimpleMarker">
              <Option type="Map">
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol type="line" is_animated="0" force_rhr="0" alpha="1" frame_rate="10" name="" clip_to_extent="1">
        ...
        <layer locked="0" enabled="1" id="{fb5532e3-dcc1-4365-b2c3-e27d7c5e6bb3}" pass="0" class="SimpleLine">
          <Option type="Map">
            <Option type="QString" value="0" name="align_dash_pattern"/>
            <Option type="QString" value="square" name="capstyle"/>
            <Option type="QString" value="5;2" name="customdash"/>
    ...
    <DiagramCategory height="15" spacingUnit="MM" enabled="0" sizeScale="3x:0,0,0,0,0,0" width="15" showAxis="1" direction="0" opacity="1" penWidth="0" minScaleDenominator="0" labelPlacementMethod="XHeight" spacing="5" sizeType="MM" lineSizeScale="3x:0,0,0,0,0,0" scaleDependency="Area" spacingUnitScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" penColor="#000000" backgroundColor="#ffffff" minimumSize="0" diagramOrientation="Up" backgroundAlpha="255" lineSizeType="MM" barWidth="5" rotationOffset="270" penAlpha="255" scaleBasedVisibility="0">
      ...
      <axisSymbol>
        <symbol type="line" is_animated="0" force_rhr="0" alpha="1" frame_rate="10" name="" clip_to_extent="1">
          ...
          <layer locked="0" enabled="1" id="{c3dd8a49-f910-4eae-abf9-35133bffc5e1}" pass="0" class="SimpleLine">
            <Option type="Map">
              <Option type="QString" value="0" name="align_dash_pattern"/>
              <Option type="QString" value="square" name="capstyle"/>
              <Option type="QString" value="5;2" name="customdash"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="pump_type">
      <editWidget type="ValueMap">
        <config>
          <Option type="Map">
            <Option type="List" name="map">
              <Option type="Map">
                <Option type="QString" value="HEAD" name="HEAD"/>
              </Option>
              <Option type="Map">
                <Option type="QString" value="POWER" name="POWER"/>
              </Option>
            </Option>
          </Option>
        </config>
    ...
    <field configurationFlags="NoFlag" name="pump_curve">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="base_speed">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="speed_pattern">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
    ...
    <field configurationFlags="NoFlag" name="initial_setting">
      <editWidget type="TextEdit">
        <config>
          <Option type="Map">
            <Option type="bool" value="false" name="IsMultiline"/>
  ...
  <aliases>
    ...
    <alias index="3" field="pump_type" name=""/>
    <alias index="4" field="pump_curve" name=""/>
    <alias index="5" field="power" name=""/>
    <alias index="6" field="base_speed" name=""/>
    <alias index="7" field="speed_pattern" name=""/>
    <alias index="8" field="initial_status" name=""/>
    <alias index="9" field="initial_setting" name=""/>
  </aliases>
  <splitPolicies>
    ...
    <policy field="pump_type" policy="Duplicate"/>
    <policy field="pump_curve" policy="Duplicate"/>
    <policy field="power" policy="Duplicate"/>
    <policy field="base_speed" policy="Duplicate"/>
    <policy field="speed_pattern" policy="Duplicate"/>
  ...
  <defaults>
    ...
    <default expression="" field="pump_type" applyOnUpdate="0"/>
    <default expression="" field="pump_curve" applyOnUpdate="0"/>
    <default expression="" field="power" applyOnUpdate="0"/>
    <default expression="" field="base_speed" applyOnUpdate="0"/>
    <default expression="" field="speed_pattern" applyOnUpdate="0"/>
  ...
  <constraints>
    ...
    <constraint unique_strength="0" constraints="0" field="pump_type" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="pump_curve" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="power" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="base_speed" exp_strength="0" notnull_strength="0"/>
    <constraint unique_strength="0" constraints="0" field="speed_pattern" exp_strength="0" notnull_strength="0"/>
  ...
  <constraintExpressions>
    ...
    <constraint exp="" field="pump_curve" desc=""/>
    <constraint exp="" field="power" desc=""/>
    <constraint exp="" field="base_speed" desc=""/>
    <constraint exp="" field="speed_pattern" desc=""/>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column type="field" width="-1" hidden="0" name="pump_type"/>
      <column type="field" width="-1" hidden="0" name="initial_status"/>
      <column type="field" width="-1" hidden="0" name="initial_setting"/>
      <column type="field" width="-1" hidden="0" name="pump_curve"/>
      <column type="field" width="-1" hidden="0" name="power"/>
      <column type="field" width="-1" hidden="0" name="base_speed"/>
      <column type="field" width="-1" hidden="0" name="speed_pattern"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    <field editable="1" name="base_speed"/>
    <field editable="1" name="efficiency"/>
    <field editable="1" name="end_node_name"/>
    <field editable="1" name="energy_pattern"/>
    <field editable="1" name="energy_price"/>
    <field editable="1" name="initial_setting"/>
    <field editable="1" name="initial_status"/>
    <field editable="1" name="link_type"/>
    <field editable="1" name="name"/>
    <field editable="1" name="power"/>
    <field editable="1" name="powerbase_speed"/>
    <field editable="1" name="pump_curve"/>
    <field editable="1" name="pump_curve_name"/>
    <field editable="1" name="pump_type"/>
    <field editable="1" name="speed_pattern"/>
    <field editable="1" name="speed_pattern_name"/>
    <field editable="1" name="start_node_name"/>
    <field editable="1" name="tag"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="base_speed"/>
    <field labelOnTop="0" name="efficiency"/>
    <field labelOnTop="0" name="end_node_name"/>
    <field labelOnTop="0" name="energy_pattern"/>
    <field labelOnTop="0" name="energy_price"/>
    <field labelOnTop="0" name="initial_setting"/>
    <field labelOnTop="0" name="initial_status"/>
    <field labelOnTop="0" name="link_type"/>
    <field labelOnTop="0" name="name"/>
    <field labelOnTop="0" name="power"/>
    <field labelOnTop="0" name="powerbase_speed"/>
    <field labelOnTop="0" name="pump_curve"/>
    <field labelOnTop="0" name="pump_curve_name"/>
    <field labelOnTop="0" name="pump_type"/>
    <field labelOnTop="0" name="speed_pattern"/>
    <field labelOnTop="0" name="speed_pattern_name"/>
    <field labelOnTop="0" name="start_node_name"/>
    <field labelOnTop="0" name="tag"/>
  </labelOnTop>
  <reuseLastValue>
    <field reuseLastValue="0" name="base_speed"/>
    <field reuseLastValue="0" name="efficiency"/>
    <field reuseLastValue="0" name="end_node_name"/>
    <field reuseLastValue="0" name="energy_pattern"/>
    <field reuseLastValue="0" name="energy_price"/>
    <field reuseLastValue="0" name="initial_setting"/>
    <field reuseLastValue="0" name="initial_status"/>
    <field reuseLastValue="0" name="link_type"/>
    <field reuseLastValue="0" name="name"/>
    <field reuseLastValue="0" name="power"/>
    <field reuseLastValue="0" name="powerbase_speed"/>
    <field reuseLastValue="0" name="pump_curve"/>
    <field reuseLastValue="0" name="pump_curve_name"/>
    <field reuseLastValue="0" name="pump_type"/>
    <field reuseLastValue="0" name="speed_pattern"/>
    <field reuseLastValue="0" name="speed_pattern_name"/>
