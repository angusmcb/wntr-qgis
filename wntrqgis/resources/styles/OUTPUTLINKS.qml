...
<qgis minScale="100000000" hasScaleBasedVisibilityFlag="0" maxScale="0" simplifyDrawingHints="1" styleCategories="AllStyleCategories" version="3.38.3-Grenoble" simplifyMaxScale="1" labelsEnabled="0" symbologyReferenceScale="-1" simplifyAlgorithm="0" simplifyDrawingTol="1" simplifyLocal="1" readOnly="0">
  <flags>
  ...
  <temporal startField="" startExpression="" fixedDuration="0" endField="" durationUnit="min" mode="5" endExpression="" durationField="" accumulate="0" enabled="1" limitMode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation extrusionEnabled="0" zscale="1" showMarkerSymbolInSurfacePlots="0" clamping="Terrain" extrusion="0" binding="Centroid" respectLayerSymbol="1" zoffset="0" type="IndividualFeatures" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="line" frame_rate="10">
        ...
        <layer locked="0" id="{7913e001-f961-41f5-8e98-8a3a37ddf9c3}" class="SimpleLine" enabled="1" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="fill" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{050df678-6f99-488c-9fce-c55c92be6dc3}" class="SimpleFill" enabled="1" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="marker" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{69482747-51bf-4944-8cf1-646392016ff5}" class="SimpleMarker" enabled="1" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 symbollevels="0" referencescale="-1" enableorderby="0" graduatedMethod="GraduatedColor" attr=" wntr_result_at_current_time( velocity )" type="graduatedSymbol" forceraster="0">
    <ranges>
      <range label="0,9538 - 0,9538" symbol="0" lower="0.953814923763275" render="true" uuid="{3a8448a6-4e94-43f8-bd63-fd626e367a31}" upper="0.953814923763275"/>
      <range label="0,9538 - 0,9538" symbol="1" lower="0.953814923763275" render="true" uuid="{10815e43-2804-4425-9e02-eb2cb367ad50}" upper="0.953814923763275"/>
      <range label="0,9538 - 0,9538" symbol="2" lower="0.953814923763275" render="true" uuid="{baa0c31d-4263-4535-ab5e-28b0cdbc3158}" upper="0.953814923763275"/>
      <range label="0,9538 - 0,9538" symbol="3" lower="0.953814923763275" render="true" uuid="{54d41e58-3b6c-4733-aea1-8d6fb0c877e6}" upper="0.953814923763275"/>
      <range label="0,9538 - 0,9538" symbol="4" lower="0.953814923763275" render="true" uuid="{9da891fd-00c1-480f-89b0-1a8e60701671}" upper="0.953814923763275"/>
    </ranges>
    <symbols>
      <symbol name="0" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="line" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}" class="SimpleLine" enabled="1" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option name="expression" value="0.108333*(max( sqrt(abs(wntr_result_at_current_time( flowrate )) / maximum(array_max(flowrate))) * 4,0.2))" type="QString"/>
        ...
        <layer locked="0" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}" class="MarkerLine" enabled="1" pass="0">
          <Option type="Map">
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  <Option name="active" value="true" type="bool"/>
                  <Option name="expression" value="max( sqrt(wntr_result_at_current_time( flowrate ) / maximum(array_max(flowrate))) * 4,0.2)" type="QString"/>
                  <Option name="type" value="3" type="int"/>
                </Option>
              </Option>
              <Option name="type" value="collection" type="QString"/>
          ...
          <symbol name="@0@1" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}" class="SimpleMarker" enabled="1" pass="0">
              <Option type="Map">
                <Option name="angle" value="0" type="QString"/>
                <Option name="cap_style" value="square" type="QString"/>
                ...
                <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="offset_unit" value="MM" type="QString"/>
                <Option name="outline_color" value="48,18,59,255,rgb:0.18823529411764706,0.07058823529411765,0.23137254901960785,1" type="QString"/>
                <Option name="outline_style" value="solid" type="QString"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="angle" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="if(wntr_result_at_current_time( flowrate ) &lt;0,180,0)" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                    <Option name="size" type="Map">
                      <Option name="active" value="true" type="bool"/>
                      <Option name="expression" value="max( sqrt(abs(wntr_result_at_current_time( flowrate )) /  maximum(array_max(flowrate))) * 4,0.2)" type="QString"/>
                      <Option name="type" value="3" type="int"/>
                    </Option>
                  </Option>
                  <Option name="type" value="collection" type="QString"/>
      ...
      <symbol name="1" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="line" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}" class="SimpleLine" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="40,188,235,255,rgb:0.15686274509803921,0.73725490196078436,0.92156862745098034,1" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="0.26" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="0" type="QString"/>
        ...
        <layer locked="0" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}" class="MarkerLine" enabled="1" pass="0">
          ...
          <symbol name="@1@1" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}" class="SimpleMarker" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="offset_unit" value="MM" type="QString"/>
                <Option name="outline_color" value="40,188,235,255,rgb:0.15686274509803921,0.73725490196078436,0.92156862745098034,1" type="QString"/>
                <Option name="outline_style" value="solid" type="QString"/>
                <Option name="outline_width" value="0" type="QString"/>
                <Option name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="outline_width_unit" value="MM" type="QString"/>
      ...
      <symbol name="2" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="line" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}" class="SimpleLine" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="164,252,60,255,rgb:0.64313725490196083,0.9882352941176471,0.23529411764705882,1" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="0.26" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="0" type="QString"/>
        ...
        <layer locked="0" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}" class="MarkerLine" enabled="1" pass="0">
          ...
          <symbol name="@2@1" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}" class="SimpleMarker" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="offset_unit" value="MM" type="QString"/>
                <Option name="outline_color" value="164,252,60,255,rgb:0.64313725490196083,0.9882352941176471,0.23529411764705882,1" type="QString"/>
                <Option name="outline_style" value="solid" type="QString"/>
                <Option name="outline_width" value="0" type="QString"/>
                <Option name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="outline_width_unit" value="MM" type="QString"/>
      ...
      <symbol name="3" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="line" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}" class="SimpleLine" enabled="1" pass="0">
          <Option type="Map">
            ...
            <Option name="draw_inside_polygon" value="0" type="QString"/>
            <Option name="joinstyle" value="bevel" type="QString"/>
            <Option name="line_color" value="251,126,33,255,rgb:0.98431372549019602,0.49411764705882355,0.12941176470588237,1" type="QString"/>
            <Option name="line_style" value="solid" type="QString"/>
            <Option name="line_width" value="0.26" type="QString"/>
            <Option name="line_width_unit" value="MM" type="QString"/>
            <Option name="offset" value="0" type="QString"/>
        ...
        <layer locked="0" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}" class="MarkerLine" enabled="1" pass="0">
          ...
          <symbol name="@3@1" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}" class="SimpleMarker" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="offset_unit" value="MM" type="QString"/>
                <Option name="outline_color" value="251,126,33,255,rgb:0.98431372549019602,0.49411764705882355,0.12941176470588237,1" type="QString"/>
                <Option name="outline_style" value="solid" type="QString"/>
                <Option name="outline_width" value="0" type="QString"/>
                <Option name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="outline_width_unit" value="MM" type="QString"/>
      ...
      <symbol name="4" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="line" frame_rate="10">
        <data_defined_properties>
          <Option type="Map">
            <Option name="name" value="" type="QString"/>
            <Option name="properties"/>
        ...
        <layer locked="0" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}" class="MarkerLine" enabled="1" pass="0">
          ...
          <symbol name="@4@1" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="marker" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" value="" type="QString"/>
                <Option name="properties"/>
            ...
            <layer locked="0" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}" class="SimpleMarker" enabled="1" pass="0">
              <Option type="Map">
                ...
                <Option name="offset_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="offset_unit" value="MM" type="QString"/>
                <Option name="outline_color" value="122,4,3,255,rgb:0.47843137254901963,0.01568627450980392,0.01176470588235294,1" type="QString"/>
                <Option name="outline_style" value="solid" type="QString"/>
                <Option name="outline_width" value="0" type="QString"/>
                <Option name="outline_width_map_unit_scale" value="3x:0,0,0,0,0,0" type="QString"/>
                <Option name="outline_width_unit" value="MM" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="line" frame_rate="10">
        ...
        <layer locked="0" id="{e99b65bf-5d24-4f4b-bac1-52bab1add944}" class="SimpleLine" enabled="1" pass="0">
          <Option type="Map">
            <Option name="align_dash_pattern" value="0" type="QString"/>
            <Option name="capstyle" value="square" type="QString"/>
            <Option name="customdash" value="5;2" type="QString"/>
  ...
  <SingleCategoryDiagramRenderer diagramType="Histogram" attributeLegend="1">
    <DiagramCategory barWidth="5" sizeScale="3x:0,0,0,0,0,0" spacingUnitScale="3x:0,0,0,0,0,0" backgroundColor="#ffffff" lineSizeScale="3x:0,0,0,0,0,0" rotationOffset="270" minScaleDenominator="0" height="15" diagramOrientation="Up" enabled="0" labelPlacementMethod="XHeight" spacing="5" opacity="1" minimumSize="0" sizeType="MM" scaleDependency="Area" width="15" spacingUnit="MM" scaleBasedVisibility="0" penColor="#000000" lineSizeType="MM" backgroundAlpha="255" penWidth="0" showAxis="1" penAlpha="255" maxScaleDenominator="1e+08" direction="0">
      <fontProperties description="Ubuntu,11,-1,5,50,0,0,0,0,0" italic="0" style="" strikethrough="0" underline="0" bold="0"/>
      ...
      <axisSymbol>
        <symbol name="" alpha="1" clip_to_extent="1" is_animated="0" force_rhr="0" type="line" frame_rate="10">
          ...
          <layer locked="0" id="{0c65d7c0-5d8b-473e-b12c-6315e8a9954d}" class="SimpleLine" enabled="1" pass="0">
            <Option type="Map">
              <Option name="align_dash_pattern" value="0" type="QString"/>
              <Option name="capstyle" value="square" type="QString"/>
              <Option name="customdash" value="5;2" type="QString"/>
  ...
  <DiagramLayerSettings placement="2" obstacle="0" linePlacementFlags="18" dist="0" priority="0" zIndex="0" showAll="1">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
  ...
  <aliases>
    ...
    <alias name="" field="flowrate" index="1"/>
    <alias name="" field="velocity" index="2"/>
    <alias name="" field="headloss" index="3"/>
  </aliases>
  <splitPolicies>
    <policy field="name" policy="Duplicate"/>
    <policy field="flowrate" policy="Duplicate"/>
    <policy field="velocity" policy="Duplicate"/>
    <policy field="headloss" policy="Duplicate"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy field="name" policy="Duplicate"/>
    <policy field="flowrate" policy="Duplicate"/>
  ...
  <defaults>
    ...
    <default field="flowrate" applyOnUpdate="0" expression=""/>
    <default field="velocity" applyOnUpdate="0" expression=""/>
    <default field="headloss" applyOnUpdate="0" expression=""/>
  </defaults>
  <constraints>
    <constraint unique_strength="0" field="name" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="flowrate" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="velocity" exp_strength="0" constraints="0" notnull_strength="0"/>
    <constraint unique_strength="0" field="headloss" exp_strength="0" constraints="0" notnull_strength="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortOrder="0" sortExpression="">
    <columns>
      ...
      <column name="flowrate" width="621" hidden="0" type="field"/>
      <column name="velocity" width="-1" hidden="0" type="field"/>
      <column name="headloss" width="-1" hidden="0" type="field"/>
