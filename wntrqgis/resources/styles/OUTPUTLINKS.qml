...
<qgis maxScale="0" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" simplifyLocal="1" labelsEnabled="0" simplifyDrawingHints="1" symbologyReferenceScale="-1" simplifyDrawingTol="1" styleCategories="AllStyleCategories" minScale="100000000" simplifyMaxScale="1" version="3.38.3-Grenoble">
  <flags>
  ...
  <elevation extrusionEnabled="0" extrusion="0" zscale="1" respectLayerSymbol="1" showMarkerSymbolInSurfacePlots="0" binding="Centroid" type="IndividualFeatures" clamping="Terrain" zoffset="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{7913e001-f961-41f5-8e98-8a3a37ddf9c3}">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="fill" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleFill" id="{050df678-6f99-488c-9fce-c55c92be6dc3}">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{69482747-51bf-4944-8cf1-646392016ff5}">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" graduatedMethod="GraduatedColor" type="graduatedSymbol" enableorderby="0" attr=" wntr_result_at_current_time( velocity )" referencescale="-1" symbollevels="0">
    <ranges>
      <range render="true" uuid="{b4636c6c-9cf5-4b85-8c0c-847cd458b671}" label="0 - 0,6" symbol="0" upper="0.600000000000000" lower="0.000000000000000"/>
      <range render="true" uuid="{3505ed47-ff6e-4bad-a05a-17985e2a768d}" label="0,6 - 1,2" symbol="1" upper="1.200000000000000" lower="0.600000000000000"/>
      <range render="true" uuid="{edfe32c3-6ed2-4a99-8743-d017725d384f}" label="1,2 - 1,8" symbol="2" upper="1.800000000000000" lower="1.200000000000000"/>
      <range render="true" uuid="{3c575fb3-6517-40f3-90eb-6c67c7aafeec}" label="1,8 - 2,4" symbol="3" upper="2.400000000000000" lower="1.800000000000000"/>
      <range render="true" uuid="{58dc5826-e9e9-4ad2-aa3a-a32254becd71}" label="2,4 - 3" symbol="4" upper="3.000000000000000" lower="2.400000000000000"/>
    </ranges>
    <symbols>
      <symbol alpha="1" name="0" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="5;2" name="customdash" type="QString"/>
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="48,18,59,255,rgb:0.18823529411764706,0.07058823529411765,0.23137254901960785,1" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
            ...
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  ...
                  <Option value="0.108333*(max( sqrt(abs(wntr_result_at_current_time( flowrate )) / maximum(array_max(flowrate))) * 4,0.2))" name="expression" type="QString"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="MarkerLine" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}">
          <Option type="Map">
          ...
          <data_defined_properties>
            <Option type="Map">
              ...
              <Option name="properties" type="Map">
                <Option name="outlineWidth" type="Map">
                  <Option value="true" name="active" type="bool"/>
                  <Option value="max( sqrt(wntr_result_at_current_time( flowrate ) / maximum(array_max(flowrate))) * 4,0.2)" name="expression" type="QString"/>
                  <Option value="3" name="type" type="int"/>
                </Option>
              </Option>
              <Option value="collection" name="type" type="QString"/>
          ...
          <symbol alpha="1" name="@0@1" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}">
              <Option type="Map">
                <Option value="0" name="angle" type="QString"/>
                <Option value="square" name="cap_style" type="QString"/>
                ...
                <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                <Option value="MM" name="offset_unit" type="QString"/>
                <Option value="48,18,59,255,rgb:0.18823529411764706,0.07058823529411765,0.23137254901960785,1" name="outline_color" type="QString"/>
                <Option value="solid" name="outline_style" type="QString"/>
                ...
                <Option type="Map">
                  ...
                  <Option name="properties" type="Map">
                    <Option name="angle" type="Map">
                      <Option value="true" name="active" type="bool"/>
                      <Option value="if(wntr_result_at_current_time( flowrate ) &lt;0,180,0)" name="expression" type="QString"/>
                      <Option value="3" name="type" type="int"/>
                    </Option>
                    <Option name="size" type="Map">
                      <Option value="true" name="active" type="bool"/>
                      <Option value="max( sqrt(abs(wntr_result_at_current_time( flowrate )) /  maximum(array_max(flowrate))) * 4,0.2)" name="expression" type="QString"/>
                      <Option value="3" name="type" type="int"/>
                    </Option>
                  </Option>
                  <Option value="collection" name="type" type="QString"/>
      ...
      <symbol alpha="1" name="1" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}">
          <Option type="Map">
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="40,188,235,255,rgb:0.15686274509803921,0.73725490196078436,0.92156862745098034,1" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
            <Option value="0.26" name="line_width" type="QString"/>
            <Option value="MM" name="line_width_unit" type="QString"/>
            <Option value="0" name="offset" type="QString"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="MarkerLine" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}">
          ...
          <symbol alpha="1" name="@1@1" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}">
              <Option type="Map">
                ...
                <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                <Option value="MM" name="offset_unit" type="QString"/>
                <Option value="40,188,235,255,rgb:0.15686274509803921,0.73725490196078436,0.92156862745098034,1" name="outline_color" type="QString"/>
                <Option value="solid" name="outline_style" type="QString"/>
                <Option value="0" name="outline_width" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="outline_width_map_unit_scale" type="QString"/>
                <Option value="MM" name="outline_width_unit" type="QString"/>
      ...
      <symbol alpha="1" name="2" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}">
          <Option type="Map">
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="164,252,60,255,rgb:0.64313725490196083,0.9882352941176471,0.23529411764705882,1" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
            <Option value="0.26" name="line_width" type="QString"/>
            <Option value="MM" name="line_width_unit" type="QString"/>
            <Option value="0" name="offset" type="QString"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="MarkerLine" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}">
          ...
          <symbol alpha="1" name="@2@1" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}">
              <Option type="Map">
                ...
                <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                <Option value="MM" name="offset_unit" type="QString"/>
                <Option value="164,252,60,255,rgb:0.64313725490196083,0.9882352941176471,0.23529411764705882,1" name="outline_color" type="QString"/>
                <Option value="solid" name="outline_style" type="QString"/>
                <Option value="0" name="outline_width" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="outline_width_map_unit_scale" type="QString"/>
                <Option value="MM" name="outline_width_unit" type="QString"/>
      ...
      <symbol alpha="1" name="3" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}">
          <Option type="Map">
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="251,126,33,255,rgb:0.98431372549019602,0.49411764705882355,0.12941176470588237,1" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
            <Option value="0.26" name="line_width" type="QString"/>
            <Option value="MM" name="line_width_unit" type="QString"/>
            <Option value="0" name="offset" type="QString"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="MarkerLine" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}">
          ...
          <symbol alpha="1" name="@3@1" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}">
              <Option type="Map">
                ...
                <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                <Option value="MM" name="offset_unit" type="QString"/>
                <Option value="251,126,33,255,rgb:0.98431372549019602,0.49411764705882355,0.12941176470588237,1" name="outline_color" type="QString"/>
                <Option value="solid" name="outline_style" type="QString"/>
                <Option value="0" name="outline_width" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="outline_width_map_unit_scale" type="QString"/>
                <Option value="MM" name="outline_width_unit" type="QString"/>
      ...
      <symbol alpha="1" name="4" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" name="name" type="QString"/>
            <Option name="properties"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{c24723f9-6f2b-4e55-b82e-506ac7b1c631}">
          <Option type="Map">
            ...
            <Option value="0" name="draw_inside_polygon" type="QString"/>
            <Option value="bevel" name="joinstyle" type="QString"/>
            <Option value="122,4,3,255,rgb:0.47843137254901963,0.01568627450980392,0.01176470588235294,1" name="line_color" type="QString"/>
            <Option value="solid" name="line_style" type="QString"/>
            <Option value="0.26" name="line_width" type="QString"/>
            <Option value="MM" name="line_width_unit" type="QString"/>
            <Option value="0" name="offset" type="QString"/>
        ...
        <layer enabled="1" locked="0" pass="0" class="MarkerLine" id="{a5d478f7-30f3-4a49-b3e6-a6af5d042f79}">
          ...
          <symbol alpha="1" name="@4@1" is_animated="0" frame_rate="10" type="marker" clip_to_extent="1" force_rhr="0">
            <data_defined_properties>
              <Option type="Map">
                <Option value="" name="name" type="QString"/>
                <Option name="properties"/>
            ...
            <layer enabled="1" locked="0" pass="0" class="SimpleMarker" id="{0bdddaf9-e32a-42e8-bd3d-ac1a969cf14c}">
              <Option type="Map">
                ...
                <Option value="3x:0,0,0,0,0,0" name="offset_map_unit_scale" type="QString"/>
                <Option value="MM" name="offset_unit" type="QString"/>
                <Option value="122,4,3,255,rgb:0.47843137254901963,0.01568627450980392,0.01176470588235294,1" name="outline_color" type="QString"/>
                <Option value="solid" name="outline_style" type="QString"/>
                <Option value="0" name="outline_width" type="QString"/>
                <Option value="3x:0,0,0,0,0,0" name="outline_width_map_unit_scale" type="QString"/>
                <Option value="MM" name="outline_width_unit" type="QString"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
        ...
        <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{e99b65bf-5d24-4f4b-bac1-52bab1add944}">
          <Option type="Map">
            <Option value="0" name="align_dash_pattern" type="QString"/>
            <Option value="square" name="capstyle" type="QString"/>
            <Option value="5;2" name="customdash" type="QString"/>
    ...
    <DiagramCategory scaleBasedVisibility="0" penWidth="0" showAxis="1" width="15" diagramOrientation="Up" direction="0" spacingUnit="MM" spacing="5" penColor="#000000" minScaleDenominator="0" lineSizeScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" spacingUnitScale="3x:0,0,0,0,0,0" enabled="0" height="15" rotationOffset="270" penAlpha="255" scaleDependency="Area" sizeScale="3x:0,0,0,0,0,0" maxScaleDenominator="1e+08" backgroundColor="#ffffff" lineSizeType="MM" sizeType="MM" barWidth="5" backgroundAlpha="255" opacity="1" minimumSize="0">
      ...
      <axisSymbol>
        <symbol alpha="1" name="" is_animated="0" frame_rate="10" type="line" clip_to_extent="1" force_rhr="0">
          ...
          <layer enabled="1" locked="0" pass="0" class="SimpleLine" id="{0c65d7c0-5d8b-473e-b12c-6315e8a9954d}">
            <Option type="Map">
              <Option value="0" name="align_dash_pattern" type="QString"/>
              <Option value="square" name="capstyle" type="QString"/>
              <Option value="5;2" name="customdash" type="QString"/>
  ...
  <DiagramLayerSettings showAll="1" linePlacementFlags="18" placement="2" zIndex="0" priority="0" dist="0" obstacle="0">
    <properties>
      <Option type="Map">
        <Option value="" name="name" type="QString"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field name="flowrate" configurationFlags="NoFlag">
    ...
    <field name="headloss" configurationFlags="NoFlag">
      <editWidget type="List">
        <config>
          <Option type="Map">
            <Option value="false" name="EmptyIsEmptyArray" type="bool"/>
  ...
  <aliases>
    ...
    <alias name="" index="1" field="flowrate"/>
    <alias name="" index="2" field="headloss"/>
    <alias name="" index="3" field="velocity"/>
  </aliases>
  <splitPolicies>
    <policy policy="Duplicate" field="name"/>
    <policy policy="Duplicate" field="flowrate"/>
    <policy policy="Duplicate" field="headloss"/>
    <policy policy="Duplicate" field="velocity"/>
  </splitPolicies>
  <duplicatePolicies>
    <policy policy="Duplicate" field="name"/>
    <policy policy="Duplicate" field="flowrate"/>
  ...
  <defaults>
    ...
    <default applyOnUpdate="0" field="flowrate" expression=""/>
    <default applyOnUpdate="0" field="headloss" expression=""/>
  ...
  <constraints>
    ...
    <constraint field="flowrate" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="headloss" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
    <constraint field="velocity" constraints="0" unique_strength="0" notnull_strength="0" exp_strength="0"/>
  </constraints>
  <constraintExpressions>
    <constraint field="name" exp="" desc=""/>
    <constraint field="flowrate" exp="" desc=""/>
    <constraint field="headloss" exp="" desc=""/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      ...
      <column hidden="0" name="flowrate" type="field" width="621"/>
      <column hidden="0" name="velocity" type="field" width="-1"/>
      <column hidden="0" name="headloss" type="field" width="-1"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="end_node_name" editable="1"/>
    <field name="fid" editable="1"/>
    <field name="flowrate" editable="1"/>
    <field name="friction_factor" editable="1"/>
    <field name="headloss" editable="1"/>
    <field name="initial_status" editable="1"/>
    <field name="length" editable="1"/>
    <field name="link_type" editable="1"/>
    <field name="minor_loss" editable="1"/>
    <field name="name" editable="1"/>
    <field name="quality" editable="1"/>
    <field name="reaction_rate" editable="1"/>
    <field name="roughness" editable="1"/>
    <field name="setting" editable="1"/>
    <field name="start_node_name" editable="1"/>
  ...
  <labelOnTop>
    ...
    <field name="end_node_name" labelOnTop="0"/>
    <field name="fid" labelOnTop="0"/>
    <field name="flowrate" labelOnTop="0"/>
    <field name="friction_factor" labelOnTop="0"/>
    <field name="headloss" labelOnTop="0"/>
    <field name="initial_status" labelOnTop="0"/>
    <field name="length" labelOnTop="0"/>
    <field name="link_type" labelOnTop="0"/>
    <field name="minor_loss" labelOnTop="0"/>
    <field name="name" labelOnTop="0"/>
    <field name="quality" labelOnTop="0"/>
    <field name="reaction_rate" labelOnTop="0"/>
    <field name="roughness" labelOnTop="0"/>
    <field name="setting" labelOnTop="0"/>
    <field name="start_node_name" labelOnTop="0"/>
  ...
  <reuseLastValue>
    ...
    <field name="end_node_name" reuseLastValue="0"/>
    <field name="fid" reuseLastValue="0"/>
    <field name="flowrate" reuseLastValue="0"/>
    <field name="friction_factor" reuseLastValue="0"/>
    <field name="headloss" reuseLastValue="0"/>
    <field name="initial_status" reuseLastValue="0"/>
    <field name="length" reuseLastValue="0"/>
    <field name="link_type" reuseLastValue="0"/>
    <field name="minor_loss" reuseLastValue="0"/>
    <field name="name" reuseLastValue="0"/>
    <field name="quality" reuseLastValue="0"/>
    <field name="reaction_rate" reuseLastValue="0"/>
    <field name="roughness" reuseLastValue="0"/>
    <field name="setting" reuseLastValue="0"/>
    <field name="start_node_name" reuseLastValue="0"/>
